...
if __name__ == "__main__":
  ...
  for param in params_VBS:
    for param2 in params_VBS:
      if ((param2[0],param[0]) not in c) & (param2[0] != param[0]) :
        c.append((param[0],param2[0]))
	print("new restrict",(param2[1],param[1]))
        z=z+1   
	 
        #if param[0] == 21 or param[0] == 28: continue ; # already existing in the folder 
        f_restrict = open ('restrict_'+ param[1] +'_'+param2[1] +'_massless.dat', 'w')
        f_restrict.write (contents_before)
        
        for param3 in params:
    ...
    # loop over parameters to be written
          ...
          if param[0] == param3[0]:
	    f_restrict.write ('   ' + param[0] + ' 9.999999e-01 # ' + param[1] + '\n')
          if (param2[0] != param3[0]) & (param[0] != param3[0]):
            f_restrict.write ('   ' + param3[0] + ' 0 # ' + param3[1] + '\n') 
